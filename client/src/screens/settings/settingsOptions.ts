...
export const COLOR_THEME_OPTIONS: ColorThemeOption[] = [
  ...
  {
    name: "purple",
    titleKey: "color_theme_purple",
    descKey: "color_theme_purple_desc",
    icon: "droplet",
  },
];
...
export const UNITS_PRESET_OPTIONS: UnitsPresetOption[] = [
  ...
  {
    preset: "english",
    titleKey: "units_english",
    descKey: "units_english_desc",
  },
