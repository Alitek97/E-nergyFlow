...
export default function AccountSettingsScreen() {
  ...
  const strings = {
    ...
    removePhotoError: isRTL
      ? "تعذر إزالة الصورة"
      : "Could not remove profile photo",
    pickerUnavailable: isRTL
      ? "ميزة اختيار الصور غير متاحة"
    ...
    signOut: t("sign_out"),
    signOutHint: t("settings_sign_out_hint"),
  };
  ...
  const handleChooseNewPhoto = async () => {
    ...
    try {
      ...
      const ext = (asset.mimeType?.split("/")[1] || "jpg").replace(
        "jpeg",
        "jpg",
      );
  ...
  const disabledHint = !isSupabaseConfigured
    ? strings.unavailableHint
    : !canEditProfile
      ? strings.guestHint
      : null;
      ...
      >
        ...
        >
          ...
          <TextInput
            ...
            value={displayName}
            onChangeText={(text) =>
              setDisplayName(text.slice(0, MAX_DISPLAY_NAME))
            }
          ...
          >
            ...
            <View style={styles.textBlock}>
              <ThemedText
                ...
                style={[
                  styles.rowTitle,
                  { textAlign: isRTL ? "right" : "left", color: theme.error },
                ]}
              >
                {strings.signOut}
              </ThemedText>
