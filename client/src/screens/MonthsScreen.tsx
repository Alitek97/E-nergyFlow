        ...
        <FlatList
          ...
          renderItem={({ item }) =>
            (() => {
              ...
              const productionText = formatEnergy(production, unitsConfig, {
                prefer: "auto",
                precision: "adaptive",
              });
              const flowText = formatEnergy(
                Math.abs(exportWithdrawal),
                unitsConfig,
                { prefer: "auto", precision: "adaptive" },
              );
              const consumptionText = formatEnergy(consumption, unitsConfig, {
                prefer: "auto",
                precision: "adaptive",
              });
              return (
