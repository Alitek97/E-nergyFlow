        ...
        >
          ...
          >
            <View style={styles.header}>
              <ThemedText semanticVariant="screenTitle" style={styles.title}>
                {t("app_name")}
              </ThemedText>
              <ThemedText
            ...
            {error ? (
              <ThemedText semanticVariant="helper" style={styles.errorText}>
                {error}
              </ThemedText>
            ) : null}
              ...
              {mode === "login" && (
                ...
                >
                  <ThemedText
                    ...
                    style={[styles.forgotText, rtlText]}
                  >
                    {t("forgot_password")}
                  </ThemedText>
                </TouchableOpacity>
          ...
          <View style={styles.switchContainer}>
            {mode === "login" ? (
              <>
                <ThemedText
                  semanticVariant="helper"
                  style={[styles.switchText, rtlText]}
                >
                  {t("auth_no_account")}
                </ThemedText>
                <TouchableOpacity onPress={() => setMode("signup")}>
                  <ThemedText
                    semanticVariant="buttonText"
                    style={[styles.switchLink, rtlText]}
                  >
                    {t("create_account")}
                  </ThemedText>
                </TouchableOpacity>
